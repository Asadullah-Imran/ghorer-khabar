...
export default function ChefProfileCard({ chef, kitchen }: ChefProfileCardProps) {
  return (
    <div>
      <h3 className="font-bold text-lg text-gray-900 mb-4">Your Home Chef</h3>
      
      <div className="flex items-center gap-4 mb-6">
        {/* Chef Avatar */}
        <div className="relative">
          <div 
            className="size-16 rounded-full bg-gray-200 bg-cover bg-center border-2 border-teal-700"
        ...
        <div>
          ...
          {kitchen.isVerified && (
            <p className="text-xs text-teal-700 bg-teal-50 px-2 py-0.5 rounded inline-block">
              Hygiene Checked
            </p>
          )}
        </div>
