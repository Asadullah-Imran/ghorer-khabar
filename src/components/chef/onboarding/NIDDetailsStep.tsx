  ...
  return (
    <div className="w-full max-w-md mx-auto space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-gray-600">We need your NID information for verification</p>
      </div>

      <div className="space-y-4">
        {/* NID Name Field */}
        <div className="space-y-2">
          <label htmlFor="nidName" className="block text-sm font-medium text-gray-700">
          ...
          <input
            ...
            className={`
              ...
              ${errors?.nidName ? "border-red-500" : "border-gray-200 focus:border-[#477e77]"}
            `}
          />
          {errors?.nidName && <p className="text-sm text-red-500">{errors.nidName}</p>}
        </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`
                ...
                focus:outline-none focus:ring-2 focus:ring-[#477e77]/20
                ${errors?.phone ? "border-red-500" : "border-gray-200 focus:border-[#477e77]"}
              `}
            />
          </div>
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        <h3 className="font-semibold text-sm text-yellow-900 mb-2">🔒 Your information is secure</h3>
        <p className="text-sm text-yellow-800">
          We require NID verification to ensure food safety and build trust with customers. 
