...
export default function KitchenNameStep({ kitchenName, onChange, error }: KitchenNameStepProps) {
  return (
    <div className="w-full max-w-md mx-auto space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-gray-600">Choose a memorable name for your home kitchen</p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          className={`
            ...
            ${error ? "border-red-500" : "border-gray-200 focus:border-[#477e77]"}
          `}
        />
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <h3 className="font-semibold text-sm text-blue-900 mb-2">💡 Tips for a great name:</h3>
