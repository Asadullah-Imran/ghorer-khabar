      ...
      <div className="relative z-10 w-full max-w-5xl bg-white rounded-[2rem] shadow-2xl flex flex-col md:flex-row overflow-hidden border border-gray-100">
        ...
        <div className="w-full md:w-1/2 p-10 md:p-16">
          <div className="text-center mb-10">
            ...
            <h1 className="font-display text-3xl font-bold text-[#3d7068] tracking-tight">Ghorer Khabar</h1>
            <p className="text-[#fbb03b] text-xs font-bold uppercase tracking-widest mt-1">Savor the Taste of Home</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="my-6 relative">
              ...
              <div className="relative flex justify-center text-sm"><span className="px-2 bg-white text-gray-400">Or </span>
              </div>
            </div>
          ...
          <p className="text-center text-sm text-gray-500 mt-8">
            ...
            className="text-[#3d7068] font-bold hover:underline">Create one now</Link>
          </p>
        </div>
