      ...
      <main className="flex-1 overflow-y-auto flex flex-col">
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="flex justify-between items-end">
            ...
            <button className="flex items-center gap-2 px-4 py-2 bg-primary text-background-dark font-bold rounded-lg text-sm shadow-[0_0_15px_rgba(17,212,180,0.3)] hover:shadow-[0_0_25px_rgba(17,212,180,0.5)]">
